const locales = {
    "en": {
        ...
        "errors": {
            "error": "ERROR",
            "dm": "Error: You can't do this in private messages!",
            "emptyMsg": "Error: You can't write an empty message",
            "missingPermissions": "Error: The bot does not have such rights!"
        },
        "token": {
    ...
    "uk": {
        ...
        "infos": {
            "owner": "Власник",
            "members": "Участників",
            "vChannels": "Голосові канали",
            "tChannels": "Текстові канали",
            "roles": "Ролей",
        ...
        "errors": {
            "error": "Помилка",
            "dm": "Помилка: Ви не можете зробити це в особистих повідомлення!",
            "emptyMsg": "Помилка: Пусте повідомлення",
            "missingPermissions": "Помилка: У discord бота немає таких прав!"
        },
        "token": {
    ...
    "ru": {
        ...
        "buttons": {
            "clearLastMessages": "Очистить последние сообщения",
            "editToken": "Изменить токен бота",
            "refreshChat": "Перезагрузить канал",
        ...
        "headings": {
            "lastMessages": "Последнии сообщения",
            "guildName": "Информация",
            "autoScroll": "Авто-скролл",
        },
        "errors": {
            "error": "Ошибка",
            "dm": "Ошибка: Вы не можете сделать это в личных сообщения!",
            "emptyMsg": "Ошибка: Нельзя отправить пустое сообщение",
            "missingPermissions": "Ошибка: У discord бота нету таких прав!"
        },
        "token": {
            "prompt": "Укажите пожалуйста discord token вашего бота!",
            "confirmation": "Вы уверены?",
            "invalid": "Токен не предоставлен или токен недействителен"
        },
        "messageType": {
            "serverJoin": "присоединился к серверу",
            "pin": "прикрепил сообщение",
            "channelNews": "добавлен удаленный канал новостей",
            "boost": "забустил данный сервер"
        },
        "fileType": {
            "unknown": "не известный тип файла",
            "img": "изображение",
            "doc": "докумень",
            "pdf": "pdf файл",
            "video": "видео",
        ...
        "formatting": {
            "bold": "Жирный текст",
            "emphasis": "Акцент на текст",
            "underline": "Подчеркнутый текст",
            "strike": "Зачеркнутый текст",
            "clear": "Убрать форматирование"
        }
    },
    "fr": {
        "cCode": "fr",
    ...
    "tr": {
        ...
        "errors": {
            "error": "HATA",
            "dm": "HATA: Bunu kişisel mesajlarda yapamazsınız",
            "emptyMsg": "HATA: Boş bir mesaj gönderemezsiniz",
            "missingPermissions": "HATA: Bot böyle haklara sahip değil"
        },
        "token": {
